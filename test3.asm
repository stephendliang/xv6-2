...
int main() {
  ...
  1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      ...
      io_intense();
      getpinfo(getpid());
  20:	e8 6d 03 00 00       	call   392 <getpid>
  25:	83 ec 0c             	sub    $0xc,%esp
  28:	50                   	push   %eax
  29:	e8 84 03 00 00       	call   3b2 <getpinfo>
  2e:	83 c4 10             	add    $0x10,%esp
  for (int i = 0; i < 10; ++i) {
  31:	83 ee 01             	sub    $0x1,%esi
  34:	74 32                	je     68 <main+0x68>
    if (fork() > 0) {
  36:	e8 cf 02 00 00       	call   30a <fork>
  3b:	85 c0                	test   %eax,%eax
  3d:	7f e1                	jg     20 <main+0x20>
  for (int I = 0; I < 200000; ++I)
  ...
  51:	83 c3 01             	add    $0x1,%ebx
    printf(1,"abcdefghijklmnop %i,\n", I);
  54:	6a 01                	push   $0x1
  56:	e8 05 04 00 00       	call   460 <printf>
  for (int I = 0; I < 200000; ++I)
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	81 fb 40 0d 03 00    	cmp    $0x30d40,%ebx
  64:	75 e2                	jne    48 <main+0x48>
  66:	eb b8                	jmp    20 <main+0x20>
    }
  }

    exit();
  68:	e8 a5 02 00 00       	call   312 <exit>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop

00000070 <compute_intense>:
{
  70:	55                   	push   %ebp
  ...
  84:	31 db                	xor    %ebx,%ebx
{
  ...
  a6:	81 fb 40 0d 03 00    	cmp    $0x30d40,%ebx
  ac:	75 e2                	jne    90 <io_intense+0x10>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb ce 07 00 00       	mov    $0x7ce,%ebx
        while(*s != 0){
